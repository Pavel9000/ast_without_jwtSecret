...
import {getAll} from '../../store/actions/home/all'
import {updateOne} from '../../store/actions/home/update'
...
class Home extends Component {
    ...
    state = {
        ...
        formControls: {
            descr: {
                ...
                //     'Здесь можно пообщаться со мной',
                //     'и почитать интересные статьи'
                // ]`,
                type: 'textEditor',
                label: 'Описание',
    ...
    async componentDidMount() {
        ...
        if (!this.props.home.all.descr && !this.props.home.all.video) {
            await this.props.getAll()
        }
        let formControls = {...this.state.formControls}
        if (this.props.home.all.descr) { formControls.descr.value = this.props.home.all.descr }
        if (this.props.home.all.video) { formControls.video.value = this.props.home.all.video }
        // console.log(this.props.home.all)
