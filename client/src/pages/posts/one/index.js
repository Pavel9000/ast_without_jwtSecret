...
import {createOne} from '../../../store/actions/posts/create'
import {updateOne} from '../../../store/actions/posts/update'
...
class Create extends Component {
    ...
    async componentDidMount() {
        ...
        if (this.props.createUpdateView === 'update' || this.props.createUpdateView === 'view') {
            ...
            if (!one) {
                const url = `${this.props.config.url.isDev ? (this.props.config.url.dev.url+this.props.config.url.dev.serverPort) : this.props.config.url.url }/api/posts/${this.props.state.match.params.id}`
    ...
    createAndPushImgAndPreviewBase64 = async () => {
        ...
        let onloadImgFunc = async (name) => {
            ...
            img.src = `${this.props.url.isDev ? (this.props.url.dev.url+this.props.url.dev.clientPort) : this.props.url.url }/img/posts/${this.state.id}/${name}.jpg`
        }
