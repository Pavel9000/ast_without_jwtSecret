...
class Create extends Component {
    ...
    async componentDidMount() {
            ...
            if (!one) {
                await this.getListArr_start_Limit()
                for (let sdf in this.props.all) {
                    if (this.props.all[sdf].id === this.props.state.match.params.id) {
                        one = this.props.all[sdf]
                    }
                }
            }
    ...
    createAndPushImgAndPreviewBase64 = async () => {
        ...
        let onloadImgFunc = async (name) => {
            ...
            img.src = `${this.props.url.isDev ? (this.props.url.dev.url+this.props.url.dev.clientPort) : this.props.url.url }/img/about/${this.state.id}/${name}.jpg`
        }
                ...
                {   
                    this.state.bigImg 
                        ? <div>
                            ...
                            <img width="250px" height="333px" src={this.state.bigImg} /> 
                        </div>
                        : null
                }
                <div className={classes.littleImg_wrap}>
                    ...
                    <div 
                        ...
                        style={ this.state.showCanvas ? { display: "block" } : { display: "none" } }>
                            {/* <ResizeImg
                                ...
                                /> */}
                        {
                            this.state.resizeImgIdInput === 'preview'    
                                ? <ResizeImg
                                    needWidth={ 250 }
                                    proportion={ 1 }
                                    quality={ 0.7 }
                        ...
                        {
                            this.state.resizeImgIdInput === 'fileElem'
                                ? <ResizeImg
                                    needWidth={ 500 }
                                    proportion={ 0.75 }
                                    quality={ 1.0 }
            ...
            return (
                <div className={classes.Post}>
                    ...
                    <div className={classes.PostWrapper}>
                        {
                            !this.state.formControls.img.value[0]
                                ? <Loader />
                                : <img style={{ width: "100%" }} src={this.state.formControls.img.value[0]} />
                        }
                    </div>
                </div>
            )
